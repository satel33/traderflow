              ...
              <div className=" ">
                {
                  !result ?
                      ...
                      {!connect ?
                        ...
                        <div>
                          ...
                          <div className="relative mt-[24px]">
                            <form className="flex ">
                              <div className="m-[auto] flex max-lg:flex-col w-[311px] lg:w-[503px]">
                                <input type="text"
                                  required
                                ...
                                <Button onClick={handelMintConnect} clsName={'max-lg:mt-[40px] lg:w-[200px] max-lg:w-full'} >
                                  Mint NFT
                                </Button>
                    ...
                    <div className="text-center sm:mt-0 ">
                      <h3 className=" font-semibold leading-[140%] text-[white] text-[clamp(24px,5vw,32px)]" id="modal-title">Thank you for joining us</h3>
